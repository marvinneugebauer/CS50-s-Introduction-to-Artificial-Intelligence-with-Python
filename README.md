...
- **Project: Parser**
    + The goal in this project is to build an AI to parse sentences and extract noun phrases. Therefore we use **Natural Language Toolkit** together with a **context-free grammar formalism** to parse English sentences in ``parser.py``. 
